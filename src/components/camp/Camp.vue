<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>全部课程管理</el-breadcrumb-item>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-input placeholder="请输入内容" v-model="queryInfo.query" clearable @clear="getCampList">
      ...
      <el-table :data="campList" border stripe>
        ...
        <el-table-column prop="creator.name" label="教师"></el-table-column>
        ...
        <el-table-column label="操作">
          ...
          <template slot-scope="scope">
            <el-tooltip
              ...
              :enterable="false"
              placement="top"
              v-if="!scope.row.hasInClass"
            >
              <router-link :to="{path: '/class', query: {campId: scope.row.id}}">
                  <el-button
                  type="primary"
            ...
            >
              ...
              size="mini"
              circle
              @click="removeStudentFromCampById(scope.row.id)"
              ></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
